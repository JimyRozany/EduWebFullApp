...
<body id="top">
    ...
    <header class="header" data-header>
        <div class="container">
            ...
            <div class="header-actions">
                ...
                <button href="#" class="btn has-before" id="login-btn">
            ...
            <section class="section about" id="about" aria-label="about">
                <div class="container">
                    ...
                    <figure class="about-banner">
                        ...
                        <img src="./assets/images/about-shape-1.svg" width="360" height="420" loading="lazy"
                            alt="" class="shape about-shape-1">

                        <img src="./assets/images/about-shape-2.svg" width="371" height="220" loading="lazy"
                            alt="" class="shape about-shape-2">

                        <img src="./assets/images/about-shape-3.png" width="722" height="528" loading="lazy"
                    ...
                    <div class="about-content">
                        ...
                        <img src="./assets/images/about-shape-4.svg" width="100" height="100" loading="lazy"
      ...
      -->
            ...
            <section class="section blog has-bg-image" id="blog" aria-label="blog"
                ...
                <div class="container">
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                                    <img src="./assets/images/blog-1.jpg" width="370" height="370"
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">Become A Better Blogger: Content
                                            Planning</a>
                                    </h3>
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                                    <img src="./assets/images/blog-2.jpg" width="370" height="370"
                                        loading="lazy" alt="Become A Better Blogger: Content Planning"
                                        class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                                    <img src="./assets/images/blog-3.jpg" width="370" height="370"
                                        loading="lazy" alt="Become A Better Blogger: Content Planning"
                                        class="img-cover">
                                </figure>
                    ...
                    <img src="./assets/images/blog-shape.png" width="186" height="186" loading="lazy"
                        alt="" class="shape blog-shape">
  ...
  -->
    ...
    - custom js link
  -->
    <script src="{{ asset('./assets/js/main-script.js') }}" defer></script>
